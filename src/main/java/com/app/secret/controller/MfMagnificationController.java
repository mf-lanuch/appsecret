...
public class MfMagnificationController {
    ...
    public AjaxResult<MfMagnification> updateMfMagnification(@RequestBody UpdateMfMagDTO dto) {
        return AjaxResult.success(mfMagnificationService.updateMfMagnification(dto));
    }
}
